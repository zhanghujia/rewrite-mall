...
import com.jia.umsmall.mapper.UmsMemberMapper;
...
public class UmsMemberServiceImpl implements UmsMemberService {
    ...
    public boolean deleteById(Long id) {
        return this.umsMemberMapper.deleteByPrimaryKey(id) > 0;
    }
    ...
    public PageInfo queryAllByLimit(int page, int size) {
        return PageHelper.startPage(page, size).doSelectPageInfo(this.umsMemberMapper::selectAll);
    }
}